        ...
        <main id="MainContent" class="content-for-layout">
            ...
            <div class="slideshow-section position-relative">
                <div class="slideshow-active activate-slider" data-slick='{
                    ...
                    <div class="slide-item slide-item-bag position-relative">
                        <img class="slide-img d-none d-md-block" src="{{asset('main_view/assets/img/slideshow/f2.jpg')}}" alt="slide-2">
                        <img class="slide-img d-md-none" src="{{asset('main_view/assets/img/slideshow/f2-m.jpg')}}" alt="slide-2">
                        <div class="content-absolute content-slide">
                            <div class="container height-inherit d-flex align-items-center justify-content-end">
                                <div class="content-box slide-content slide-content-1 py-4 text-center">
                                    <h2 class="slide-heading heading_72 animate__animated animate__fadeInUp"
                    ...
                    <div class="slide-item slide-item-bag position-relative">
                        <img class="slide-img d-none d-md-block" src="{{asset('main_view/assets/img/slideshow/f3.jpg')}}" alt="slide-3">
                        <img class="slide-img d-md-none" src="{{asset('main_view/assets/img/slideshow/f3-m.jpg')}}" alt="slide-3">
                        <div class="content-absolute content-slide">
                        ...
                        <div class="row">
                                ...
                                <div class="product-card">
                                    <div class="product-card-img">
                                        <a class="hover-switch" href="collection-left-sidebar.html">
                                            <img class="secondary-img" src="{{asset('main_view/assets/img/products/furniture/9.jpg')}}"
                                                alt="product-img">
                                            <img class="primary-img" src="{{asset('main_view/assets/img/products/furniture/1.jpg')}}"
                                                alt="product-img">
                                        </a>
                            ...
                            <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                                <div class="product-card">
                                    <div class="product-card-img">
                                        <a class="hover-switch" href="collection-left-sidebar.html">
                                            <img class="secondary-img" src="{{asset('main_view/assets/img/products/furniture/10.jpg')}}"
                                                alt="product-img">
                                            <img class="primary-img" src="{{asset('main_view/assets/img/products/furniture/2.jpg')}}"
                                                alt="product-img">
                                        </a>
                            ...
                            <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                                <div class="product-card">
                                    <div class="product-card-img">
                                        <a class="hover-switch" href="collection-left-sidebar.html">
                                            <img class="secondary-img" src="{{asset('main_view/assets/img/products/furniture/11.jpg')}}"
                                                alt="product-img">
                                            <img class="primary-img" src="{{asset('main_view/assets/img/products/furniture/3.jpg')}}"
                                                alt="product-img">
                                        </a>
                            ...
                            <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                                <div class="product-card">
                                    <div class="product-card-img">
                                        <a class="hover-switch" href="collection-left-sidebar.html">
                                            <img class="secondary-img" src="{{asset('main_view/assets/img/products/furniture/14.jpg')}}"
                                                alt="product-img">
                                            <img class="primary-img" src="{{asset('main_view/assets/img/products/furniture/4.jpg')}}"
                                                alt="product-img">
                                        </a>
                                    ...
                                    <div class="product-card-details">
                                        ...
                                        <h3 class="product-card-title">
                                            <a href="collection-left-sidebar.html">Umbrella Technology tea table</a>
                                        </h3>
                                        <div class="product-card-price">
                                            <span class="card-price-regular">$1529</span>
                                            <span class="card-price-compare text-decoration-line-through">$1759</span>
            ...
            <div class="video-section mt-100 overflow-hidden">
                <div class="overlay-furniture section-spacing"
                    style="background: url('{{asset('main_view/assets/img/video/video-furniture.jpg')}}') no-repeat fixed bottom center/cover">
            ...
            <div class="single-banner-section mt-100 overflow-hidden">
                <div class="position-relative overlay">
                    <img class="single-banner-img" src="{{asset('main_view/assets/img/banner/single-banner-2.jpg')}}" alt="slide-1">
                        ...
                        <div class="article-card-container position-relative">
                            <div class="common-slider" data-slick='{
                                ...
                                <div class="article-slick-item" data-aos="fade-up" data-aos-duration="700">
                                    <div class="article-card bg-transparent p-0 shadow-none">
                                        <a class="article-card-img-wrapper" href="article.html">
                                            <img src="{{asset('main_view/assets/img/blog/furniture-1.jpg')}}" alt="img"
                                ...
                                <div class="article-slick-item" data-aos="fade-up" data-aos-duration="700">
                                    <div class="article-card bg-transparent p-0 shadow-none">
                                        <a class="article-card-img-wrapper" href="article.html">
                                            <img src="{{asset('main_view/assets/img/blog/furniture-2.jpg')}}" alt="img"
                                                class="article-card-img rounded">
                                ...
                                <div class="article-slick-item" data-aos="fade-up" data-aos-duration="700">
                                    <div class="article-card bg-transparent p-0 shadow-none">
                                        <a class="article-card-img-wrapper" href="article.html">
                                            <img src="{{asset('main_view/assets/img/blog/furniture-3.jpg')}}" alt="img"
                                                class="article-card-img rounded">
                                ...
                                <div class="article-slick-item" data-aos="fade-up" data-aos-duration="700">
                                    <div class="article-card bg-transparent p-0 shadow-none">
                                        <a class="article-card-img-wrapper" href="article.html">
                                            <img src="{{asset('main_view/assets/img/blog/furniture-4.jpg')}}" alt="img"
                                                class="article-card-img rounded">
                                            <span class="article-tag article-tag-absolute rounded">Furniture</span>
                                        </a>
                                        <p class="article-card-published text_12 d-flex align-items-center">
                            ...
                            <div class="col-xl-4 col-lg-5 col-md-6 col-12 footer-widget">
                                <div class="footer-widget-inner">
                                    <h4 class="footer-logo">
                                        <a href="https://spreethemesprevious.github.io/"><img style="width:40%;" src="{{asset('main_view/assets/img/logo-accent.png')}}" alt="Umbrella Technology"></a>
                                    </h4>
                    ...
                    <div class="minicart-loop custom-scrollbar">
                        ...
                        <div class="minicart-item d-flex">
                            <div class="mini-img-wrapper">
                                <img class="mini-img" src="{{asset('main_view/assets/img/products/furniture/1.jpg')}}" alt="img">
                            </div>
                            <div class="product-info">
                                ...
                                <div class="misc d-flex align-items-end justify-content-between">
                                    <div class="quantity d-flex align-items-center justify-content-between">
                                        <button class="qty-btn dec-qty"><img src="{{asset('main_view/assets/img/icon/minus.svg')}}"
                                                alt="minus"></button>
                                        <input class="qty-input" type="number" name="qty" value="1" min="0">
                                        <button class="qty-btn inc-qty"><img src="{{asset('main_view/assets/img/icon/plus.svg')}}"
                                                alt="plus"></button>
                                    </div>
                        ...
                        <div class="minicart-item d-flex">
                            <div class="mini-img-wrapper">
                                <img class="mini-img" src="{{asset('main_view/assets/img/products/furniture/2.jpg')}}" alt="img">
                            </div>
                            <div class="product-info">
                        ...
                        <div class="minicart-item d-flex">
                            <div class="mini-img-wrapper">
                                <img class="mini-img" src="{{asset('main_view/assets/img/products/furniture/3.jpg')}}" alt="img">
                            </div>
                            <div class="product-info">
                        ...
                        <div class="minicart-item d-flex">
                            <div class="mini-img-wrapper">
                                <img class="mini-img" src="{{asset('main_view/assets/img/products/furniture/4.jpg')}}" alt="img">
                            </div>
                            <div class="product-info">
                                <h2 class="product-title"><a href="#">Vita Lounge Chair</a></h2>
                                <p class="product-vendor">XS / Dove Gray</p>
